...
public class Connexionetu extends javax.swing.JFrame {
   ...
   /*Ouvre une connexion stockée dans la variable conn
    ...
    private void entrer(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_entrer
        ...
        String log = jTextField1.getText(); // onrécupère le login
        ...
        {
        //Etudiants e = new Etudiants (log,password1);
        ChoixEtu ch = new ChoixEtu();
        ch.setLocation(500,400); // ou bdd.setLocationRelativeTo(this);
        ch.setVisible(true);
         /*javax.swing.JOptionPane.showMessageDialog( this, "login et mot de passe correcte",
        "CONNEXION", javax.swing.JOptionPane.PLAIN_MESSAGE );*/
